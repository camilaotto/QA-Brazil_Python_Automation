...
class UrbanRoutesPage:
    ...
    comfort_icon_locator = (By.XPATH, "//img[@src='/static/media/kids.075f8d64.svg']")
    comfort_active = (By.XPATH, "//*[@id='root']/div[3]/div[1]/div[2]/div[1]/div[1]/div[1]")
    ...
    code_card = (By.CSS_SELECTOR, '.input-card-inputcode')
    ...
    switch_blanket_active = (By.CSS_SELECTOR, '.switch.workflow > div.workflow-subcontainer > div.tariff-picker.shown > div.form > div.reqs.open > div.reqs-body > div:nth-child(1) > div > div > label > div > div.switch__handle')
