...
class TestUrbanRoutes:
    ...
    def test_order_blanket_and_handkerchiefs(self):
        ...
        routes_page.click_taxi_option()
        routes_page.click_comfort_icon()
        routes_page.switch_comforton()

        assert routes_page.switch_comforton_active() is True
        time.sleep(10)
    ...
    def test_car_search_model_appears(self):
        ...
        routes_page.click_comfort_icon()
        routes_page.click_number_text(data.PHONE_NUMBER)
        routes_page.add_cartao(data.CARD_NUMBER, data.CARD_CODE)
        routes_page.comentario(data.MESSAGE_FOR_DRIVER)
